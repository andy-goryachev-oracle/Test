 ...
 * questions.
 */
package goryachev.research.runner.examples;
...
import goryachev.research.runner.ManualTestWindow;

public class EmojiTest_New extends ManualTestWindow {
    
    // TODO size, description, name
    // or, use comments? annotation?
    public static void main(String[] args) {
        launch(args);
    }

    public EmojiTest_New() {
        super(
