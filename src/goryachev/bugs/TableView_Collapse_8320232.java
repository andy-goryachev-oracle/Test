 ...
 */
public class TableView_Collapse_8320232 extends Application {
    @Override
    ...
    private static class SimpleTableItem {
        ...
        SimpleTableItem(String name, int number) {
            ...
            numberProperty().addListener((observable, oldValue, newValue) -> System.out.println("changed number: " + newValue));
        }
